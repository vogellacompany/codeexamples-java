...
public class vogellaSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case vogellaPackage.CODE_EXAMPLE: {
				CodeExample codeExample = (CodeExample)theEObject;
				T result = caseCodeExample(codeExample);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case vogellaPackage.ARTICLE: {
				Article article = (Article)theEObject;
				T result = caseArticle(article);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case vogellaPackage.WEBPAGE: {
				Webpage webpage = (Webpage)theEObject;
				T result = caseWebpage(webpage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case vogellaPackage.MY_WEB: {
				MyWeb myWeb = (MyWeb)theEObject;
				T result = caseMyWeb(myWeb);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case vogellaPackage.CATEGORY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Code Example</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Code Example</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCodeExample(CodeExample object) {
		return null;
	}
