...
public class View extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(new Person[] {new Person("Lars", "Vogel"),  new Person("Tim", "Taler"), new Person("Jim", "Knopf")});
		// React to the selection of the viewer
		// Note that the viewer return the real object and not just a string representation
